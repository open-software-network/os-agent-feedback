...
for (const result of results) {
  const key = [
    ...
    result.scenario.consentOwner || "agent",
    result.scenario.preseedConsent || "unknown",
...
if (sequences.length) {
  console.log("\n| Runtime | Mode | Consent owner | Placement | n | First asked | First accepted | Second asked | Second accepted | Agent grant | Server grant | Sequence result |");
  console.log("|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|");
