...
The question-first shape was the only tested generic-agent variant to ask, record, and continue reliably across the validation matrix. An independent agent can still ignore response metadata; no protocol can force compliance.
</Warning>
