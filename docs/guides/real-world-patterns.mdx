...
sends feedback reports directly to Epode. If you cannot control the public response route, keep the site
uninstrumented; client JavaScript is not a safe fallback.
