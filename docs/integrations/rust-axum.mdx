...
```bash
epode_artifact="$(mktemp -d)/agent-feedback-rust-0.3.1.tar.gz" &&
curl -fsSL https://app.epode.ai/static/agent-feedback-rust-0.3.1.tar.gz -o "$epode_artifact" &&
printf '%s  %s\n' '0d26e766d1e12ced3919a33d06575ba2dc4aaa8a285f8e7e3b9b069a4144b77b' "$epode_artifact" \
  | shasum -a 256 -c - &&
...
```toml
[dependencies]
agent-feedback = { path = "vendor/agent-feedback-rust-0.3.1" }
```
